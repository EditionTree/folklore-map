...
.site-banner{{position:relative;background:radial-gradient(ellipse 110% 90% at 50% 130%,rgba(196,98,42,0.13) 0%,transparent 55%),radial-gradient(ellipse 55% 120% at 15% 50%,rgba(176,144,96,0.07) 0%,transparent 55%),radial-gradient(ellipse 55% 120% at 85% 50%,rgba(176,144,96,0.05) 0%,transparent 55%),linear-gradient(180deg,#1e1408,#2c1f0e 75%);padding:16px 20px;text-align:center}}

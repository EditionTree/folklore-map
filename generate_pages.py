...
def browse_card(leg, slugmap, cats, meta, show_cat, show_summary=False):
    ...
    if show_summary and leg.get("summary"):
        summary = ('<span class="b-summary">'
                   + esc(short_desc(leg["summary"], 150)) + '</span>')
    return ('<a class="b-card" style="--cat:' + esc(colour) + '" href="' + href + '">' + chip
...
def collection_article_html(members, slugmap, cats, meta, featured_pages):
    ...
    for l in members:
        ...
        rows.append(
            '<a class="col-article" style="--cat:' + esc(colour) + '" href="' + href + '">' + media
...
.back{display:inline-flex;align-items:center;gap:7px;margin-top:26px;padding:9px 16px;font-family:'Marcellus',serif;font-size:11.5px;letter-spacing:.06em;text-transform:uppercase;color:#9d461f;background:linear-gradient(177deg,#fbf5e9,#f1e6d2);border:1px solid rgba(176,144,96,.75);border-radius:5px;text-decoration:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.6),0 1px 2px rgba(26,14,6,.08);transition:transform .14s ease,box-shadow .14s ease,border-color .14s ease,color .14s ease}.back:hover,.back:focus-visible{color:#8b3a1a;border-color:var(--accent,#c4622a);transform:translateY(-2px);box-shadow:inset 0 1px 0 rgba(255,255,255,.72),0 2px 4px rgba(26,14,6,.1),0 10px 20px -8px rgba(26,14,6,.24)}@media(prefers-reduced-motion:reduce){.back:hover,.back:focus-visible{transform:none}}
...
.col-article:hover,.col-article:focus-visible{border-color:rgba(90,70,50,.38);transform:translateY(-3px);box-shadow:inset 0 1px 0 rgba(255,255,255,.72),0 2px 5px rgba(26,14,6,.1),0 20px 38px -12px rgba(26,14,6,.28)}.col-article:hover .col-article-media img{transform:scale(1.04)}@media(prefers-reduced-motion:reduce){.col-article{transition:box-shadow .16s ease}.col-article:hover,.col-article:focus-visible{transform:none}.col-article:hover .col-article-media img{transform:none}}
.col-article:nth-child(even){flex-direction:row-reverse}
.col-article-media{flex:0 0 42%;position:relative;aspect-ratio:16/9;background:#241a10;overflow:hidden}.col-article-media img{transition:transform .3s ease}
.col-article-media img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}
.col-article-body{flex:1 1 0;min-width:0;padding:18px 26px 18px 28px;display:flex;flex-direction:column;justify-content:center;box-shadow:inset 3px 0 0 var(--cat,#8b3a1a)}
...
.col-article-name{font-family:'Marcellus',serif;font-weight:400;font-size:22px;line-height:1.15;color:#3f3023;margin-bottom:3px}.col-article-region+.col-article-summary::before,.col-article-name+.col-article-summary::before{content:'';display:block;width:104px;height:26px;margin:2px 0 8px;opacity:.42;background:url('/assets/ornaments/generated-variants/oak-divider-horizontal.webp') left center/contain no-repeat}
...
.col-index-row:hover,.col-index-row:focus-visible{border-color:rgba(90,70,50,.4);transform:translateY(-3px);box-shadow:inset 0 1px 0 rgba(255,255,255,.72),0 2px 5px rgba(26,14,6,.1),0 20px 38px -12px rgba(26,14,6,.28)}@media(prefers-reduced-motion:reduce){.col-index-row:hover,.col-index-row:focus-visible{transform:none}}
...
def track_event_script(event_type, **fields):
    ...
    return (
        ...
        '<script src="/js/page.js?v=20260823d"></script>\n'
    )
...
def collection_index_progress_script():
    ...
    return '<script src="/js/page.js?v=20260823d"></script>\n'
...
SOURCE_TIERS = {
    ...
    # Added 2026-09-08. sourcing_audit.py reported 245 unrecognised hosts across
    # 252 citations, a long tail in which all but six appeared exactly once. 237
    # are classified here; the rest are withheld on purpose, listed at the end of
    # this block, because a host-level tier for them would be the "misleading
    # guess" the comment at the top of SOURCE_TIERS rules out.
    # primary
    "archifau.llyfrgell.cymru": "primary",
    "archives.library.wales": "primary",
    "branchcollective.org": "primary",
    "collections.folger.edu": "primary",
    "confessio.ie": "primary",
    "english.nsms.ox.ac.uk": "primary",
    "eprints.bbk.ac.uk": "primary",
    "exclassics.com": "primary",
    "historycooperative.org": "primary",
    "journals.socantscot.org": "primary",
    "journals.uchicago.edu": "primary",
    "journals.umcs.pl": "primary",
    "lancelot-project.pitt.edu": "primary",
    "library2.smu.ca": "primary",
    "lostplays.folger.edu": "primary",
    "lyellcollection.org": "primary",
    "medieval.bodleian.ox.ac.uk": "primary",
    "metseditions.org": "primary",
    "newspapers.com": "primary",
    "nottingham.ac.uk": "primary",
    "oalib-perpustakaan.upi.edu": "primary",
    "onlinelibrary.wiley.com": "primary",
    "pastplace.exeter.ac.uk": "primary",
    "penelope.uchicago.edu": "primary",
    "pure.uva.nl": "primary",
    "reed-ne.webspace.durham.ac.uk": "primary",
    "research-repository.st-andrews.ac.uk": "primary",
    "research.reading.ac.uk": "primary",
    "researchonline.ljmu.ac.uk": "primary",
    "revistamirabilia.com": "primary",
    "rhyddiaithganoloesol.caerdydd.ac.uk": "primary",
    "royalsocietypublishing.org": "primary",
    "scholarlypublications.universiteitleiden.nl": "primary",
    "scottishcorpus.ac.uk": "primary",
    "sourcebooks.fordham.edu": "primary",
    "txm-bfm.huma-num.fr": "primary",
    "ucl.ac.uk": "primary",
    "ulster.ac.uk": "primary",
    "victoriannetwork.org": "primary",
    "vsnr.org": "primary",
    "wee-windaes.nls.uk": "primary",
    "yorku.ca": "primary",
    # encyclopedic
    "bestiary.ca": "encyclopedic",
    "bosworthtoller.com": "encyclopedic",
    "bywgraffiadur.cymru": "encyclopedic",
    "ebsco.com": "encyclopedic",
    "en.wikivoyage.org": "encyclopedic",
    "en.wiktionary.org": "encyclopedic",
    "etymonline.com": "encyclopedic",
    "global.oup.com": "encyclopedic",
    "thedicamillo.com": "encyclopedic",
    "wikidata.org": "encyclopedic",
    "yorkshiredictionary.york.ac.uk": "encyclopedic",
    # heritage
    "archaeologyshetland.org": "heritage",
    "artuk.org": "heritage",
    "bacas.org.uk": "heritage",
    "bgs.ac.uk": "heritage",
    "bidstonhill.org.uk": "heritage",
    "binevenaghaonb.ccght.org": "heritage",
    "blog.nationalmuseum.ch": "heritage",
    "blog.scienceandmediamuseum.org.uk": "heritage",
    "britisharchaeology.ashmus.ox.ac.uk": "heritage",
    "britishmuseum.org": "heritage",
    "cadwpublic-api.azurewebsites.net": "heritage",
    "capturingcambridge.org": "heritage",
    "chalicewell.org.uk": "heritage",
    "collection.sciencemuseumgroup.org.uk": "heritage",
    "cornwallheritage.com": "heritage",
    "cpat.org.uk": "heritage",
    "cumbriacountyhistory.org.uk": "heritage",
    "dunvegancastle.com": "heritage",
    "durhamcathedral.co.uk": "heritage",
    "englishcathedrals.co.uk": "heritage",
    "evantonhistory.com": "heritage",
    "excavations.ie": "heritage",
    "exmoor-nationalpark.gov.uk": "heritage",
    "halswaymanor.org.uk": "heritage",
    "hellensmanor.com": "heritage",
    "helstonhistory.co.uk": "heritage",
    "heritage.suffolk.gov.uk": "heritage",
    "heritagecouncil.ie": "heritage",
    "heritagerecords.nationaltrust.org.uk": "heritage",
    "heritagesouthholland.co.uk": "heritage",
    "hertsmemories.org.uk": "heritage",
    "historylinks.org.uk": "heritage",
    "historyofparliamentonline.org": "heritage",
    "holytrinitybosham.org.uk": "heritage",
    "hyltoncastle.org.uk": "heritage",
    "irisharchaeology.org": "heritage",
    "jncc.gov.uk": "heritage",
    "knowth.com": "heritage",
    "lahs.archaeologyuk.org": "heritage",
    "libraryblogs.is.ed.ac.uk": "heritage",
    "lincolncathedral.com": "heritage",
    "londonmuseum.org.uk": "heritage",
    "lowestoftheritage.org": "heritage",
    "mapofstories.scot": "heritage",
    "members.societe-jersiaise.org": "heritage",
    "museum.ie": "heritage",
    "nessofbrodgar.co.uk": "heritage",
    "new-forest-national-park.com": "heritage",
    "orfordmuseum.org.uk": "heritage",
    "ouririshheritage.org": "heritage",
    "oxfordarchaeology.com": "heritage",
    "parksandgardens.org": "heritage",
    "poolehistory.org.uk": "heritage",
    "rathcroghan.ie": "heritage",
    "registry.gsg.org.uk": "heritage",
    "saintedmund.org.uk": "heritage",
    "scienceandmediamuseum.org.uk": "heritage",
    "slha.org.uk": "heritage",
    "stanneswoodplumpton.org.uk": "heritage",
    "stmaryskentchurch.org": "heritage",
    "storyofleicester.info": "heritage",
    "stosythmuseum.co.uk": "heritage",
    "swheritage.org.uk": "heritage",
    "teesvalleymuseums.org": "heritage",
    "trove.scot": "heritage",
    "tysoehistory.org.uk": "heritage",
    "ulsterhistoricalfoundation.com": "heritage",
    "walsingham.org.uk": "heritage",
    "wellcomecollection.org": "heritage",
    "westsussexrecordofficeblog.com": "heritage",
    "wwt.org.uk": "heritage",
    "wyjs.org.uk": "heritage",
    "yorkshiredales.org.uk": "heritage",
    # secondary
    "alarichall.org.uk": "secondary",
    "chesterstandard.co.uk": "secondary",
    "christopherhadley.co.uk": "secondary",
    "dorset-nl.org.uk": "secondary",
    "dorsetlife.co.uk": "secondary",
    "fermanaghherald.com": "secondary",
    "folksongandmusichall.com": "secondary",
    "forestryjournal.co.uk": "secondary",
    "historytoday.com": "secondary",
    "inverness-courier.co.uk": "secondary",
    "iomtoday.co.im": "secondary",
    "juliettewood.com": "secondary",
    "kentonline.co.uk": "secondary",
    "kiplingsociety.co.uk": "secondary",
    "mainlynorfolk.info": "secondary",
    "monstertalk.org": "secondary",
    "nationalgeographic.com": "secondary",
    "newryjournal.co.uk": "secondary",
    "niche-canada.org": "secondary",
    "obrien.ie": "secondary",
    "open.edu": "secondary",
    "publicdomainreview.org": "secondary",
    "scotianostra.tumblr.com": "secondary",
    "scottishfield.co.uk": "secondary",
    "serenbooks.com": "secondary",
    "skeptic.org.uk": "secondary",
    "smithsonianmag.com": "secondary",
    "sussexexpress.co.uk": "secondary",
    "tetzoo.com": "secondary",
    "thehistorypress.co.uk": "secondary",
    "thetyee.ca": "secondary",
    "victorianweb.org": "secondary",
    # popular
    "animalfolklore.wordpress.com": "popular",
    "archaeology-travel.com": "popular",
    "atlanticreligion.com": "popular",
    "beltane.org": "popular",
    "beyondthepoint.co.uk": "popular",
    "blarneycastle.ie": "popular",
    "boldoutlaw.com": "popular",
    "burialsandbeyond.com": "popular",
    "causewaycoastalroute.com": "popular",
    "chbenj23.wordpress.com": "popular",
    "clasmerdin.blogspot.com": "popular",
    "curiousrambler.com": "popular",
    "dioceseofsalford.org.uk": "popular",
    "dogsinhistory.org": "popular",
    "durhamcathedral.wordpress.com": "popular",
    "earlymodernweb.org.uk": "popular",
    "exploringmidwales.co.uk": "popular",
    "fairy-folk-tale.fandom.com": "popular",
    "fairyist.com": "popular",
    "first-nature.com": "popular",
    "folklorefieldwork.substack.com": "popular",
    "futilitycloset.com": "popular",
    "gallivanting.ie": "popular",
    "godsandmonsters.info": "popular",
    "h2g2.com": "popular",
    "haeretico.com": "popular",
    "hauntedhosts.com": "popular",
    "hauntedrooms.co.uk": "popular",
    "hiddenea.com": "popular",
    "hiddenwirral.org": "popular",
    "historic-liverpool.co.uk": "popular",
    "historiesandcastles.com": "popular",
    "historyofliverpool.com": "popular",
    "holinshedrevisited.wordpress.com": "popular",
    "hypnogoria.blogspot.com": "popular",
    "information-britain.co.uk": "popular",
    "inishbofin.com": "popular",
    "irelandinruins.blogspot.com": "popular",
    "irhb.org": "popular",
    "irishpagan.school": "popular",
    "johnknifton.com": "popular",
    "kentmonsters.blogspot.com": "popular",
    "king-alfred.com": "popular",
    "lakelandhuntingmemories.com": "popular",
    "lakesguides.co.uk": "popular",
    "laoiscyclist.blogspot.com": "popular",
    "ldwa.org.uk": "popular",
    "legendofkingarthur.co.uk": "popular",
    "lordmayorsshow.london": "popular",
    "lovebritishhistory.co.uk": "popular",
    "marilwyd.cymru": "popular",
    "mccarra.co": "popular",
    "memorialdrinkingfountains.wordpress.com": "popular",
    "midwalesmyway.com": "popular",
    "mythicalbritain.co.uk": "popular",
    "mythicalencyclopedia.com": "popular",
    "newforestescapes.com": "popular",
    "obscurban-legend.fandom.com": "popular",
    "oldwirral.net": "popular",
    "pagleshampastandpresent.co.uk": "popular",
    "pembrokeshire.online": "popular",
    "radnorfforest.co.uk": "popular",
    "robinhoodlegend.com": "popular",
    "strangehistory.net": "popular",
    "stronghold-nation.com": "popular",
    "tastesofhistory.co.uk": "popular",
    "thegranthams.co.uk": "popular",
    "thehazeltree.co.uk": "popular",
    "thejournalofantiquities.com": "popular",
    "thetrustheritage.community": "popular",
    "thewickedgriffin.com": "popular",
    "towerstimes.co.uk": "popular",
    "vice.com": "popular",
    "visitdeanwye.co.uk": "popular",
    "visitmournegullionstrangford.com": "popular",
    "weird-wiltshire.co.uk": "popular",
    "wyrm.org.uk": "popular",
    "yorkshirefolktales.home.blog": "popular",
    "ztevetevans.wordpress.com": "popular",
    # Withheld deliberately, so the audit keeps flagging them:
    #   amazon.co.uk                 a shop listing, not a source; the citation itself is the problem
    #   applebyglobal.com            a law firm's site
    #   arranwhisky.com              retail
    #   betweenthecovers.com         rare-book dealer listing, same as above
    #   cantab.net                   a personal vanity domain; contents vary entirely by page
    #   doi.org                      a resolver, not a publisher; the real source is whatever it redirects to
    #   hose-rhodes-dickson.co.uk    an estate agent's property page
    #   scotlandshop.com             retail
...
def build():
    ...
    for c in cat_order:
        ...
        cards = "\n".join(browse_card(l, slugmap, cats, meta, show_cat=False, show_summary=True) for l in entries)
    ...
    for t in region_order:
        ...
        cards = "\n".join(browse_card(l, slugmap, cats, meta, show_cat=True, show_summary=True) for l in entries)
    ...
    if collection_members:
        ...
        if resolved:
            ...
            for col, members in resolved:
                ...
                land_cards.append(
                    f'<a class="col-index-row" style="--cat:{esc(dominant_accent(members, meta))}" href="{curl}" data-slug="{esc(col["slug"])}">' + media

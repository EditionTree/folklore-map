(function(){
  ...
  function renderLotw(){
    ...
    if (meta && meta.p) document.getElementById('lotwMarkPath').setAttribute('d', meta.p);
    ph.style.display = '';
